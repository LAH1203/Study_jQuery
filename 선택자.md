...
<ul id="list">
    ...
    <li> MYSQL </li>
            ...
            <input class="btn" type="button" value="#list li:even" /> - 0, 2... 짝수의 인덱스 값을 가진 엘리먼트에 대한 선택자 <br />
            <input class="btn" type="button" value="#list li:odd" /> - 1, 3.... 홀수의 인덱스 값을 가진 엘리먼트에 대한 선택자 <br />
...
[코드](https://github.com/LAH1203/Study_jQuery/blob/main/%EC%84%A0%ED%83%9D%EC%9E%90_%ED%83%90%EC%83%89%EA%B8%B0.html)

위의 코드를 다양하게 변경해서 연습해보자! 이것저것 적용해보기 굉장히 좋은 예제라고 한다.
